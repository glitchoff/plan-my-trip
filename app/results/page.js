    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-base-200 flex flex-col items-center justify-center">
                ...
                <p className="text-base-content/60">Searching real-time data...</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-base-200 pt-20 pb-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {trains.length > 0 ? (
                    <div className="mb-20">
                        <h3 className="text-2xl font-bold text-base-content mb-8">Traveling There (Trains)</h3>
                        <div className="grid grid-cols-1 gap-4">
                            {trains.map((train) => (
                                <div key={train.id} className="card bg-base-100 rounded-2xl p-6 border border-base-200 hover:border-primary hover-lift shadow-sm flex flex-row items-center justify-between">
                    ...
                    <div className="mb-20 p-8 text-center bg-base-100 rounded-2xl border border-dashed border-base-300">
                        <p className="text-base-content/60">No direct trains found for this route (or data unavailable).</p>
                    </div>
                )}
